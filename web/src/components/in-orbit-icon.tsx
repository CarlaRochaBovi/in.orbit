...
export function InOrbitIcon() {
  return (
    ...
    >
      ...
      />
      <path
        d="M14.524 5.42a7.515 7.515 0 00-9.604 9.605 7.423 7.423 0 01-2.63-1.702A7.408 7.408 0 01.31 9.78 12.016 12.016 0 019.28.81a7.408 7.408 0 013.543 1.98 7.423 7.423 0 011.701 2.63z"
        fill="url(#paint1_linear_84_337)"
      />
      <path
        d="M23.69 15.221a12.016 12.016 0 01-8.97 8.969 7.407 7.407 0 01-3.543-1.98 7.426 7.426 0 01-1.701-2.63 7.515 7.515 0 009.605-9.605c.958.362 1.857.93 2.629 1.702a7.411 7.411 0 011.98 3.544z"
